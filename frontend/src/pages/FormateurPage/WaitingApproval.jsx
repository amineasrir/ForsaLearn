  ...
  const checkApprovalStatus = async () => {
    ...
    try {
      ...
      if (response.data?.success && response.data?.isApproved) {
        ...
        setError('Your account is still under review. Please wait for approval.');
      }
    } catch (err) {
            ...
            <div className="waiting-message">
              ...
              <div className="action-buttons">
                ...
                <button
                  ...
                  disabled={loading || retryAttempts >= MAX_RETRIES}
                >
                  {loading ? (
                    <span className="spinner"></span>
                  ) : (
                    t('waitingApproval.checkStatus') || 'Check Approval Status'
                  )}
                </button>
