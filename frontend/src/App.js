...
import CheckoutPage from "./pages/ApprenantPage/CheckoutPage";
      ...
      <div className="App">
        <WishlistProvider>
            <Routes>
              ...
              <Route path="/apprenant/course/:id/checkout" element={<ApprenantProtectedRoute><CheckoutPage /></ApprenantProtectedRoute>} />
