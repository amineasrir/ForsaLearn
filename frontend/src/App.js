...
import ApprenantOrderHistory from "./pages/ApprenantPage/ApprenantOrderHistory";
  ...
  return (
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/apprenant/orders" element={<ApprenantProtectedRoute><ApprenantOrderHistory /></ApprenantProtectedRoute>} />
